Die Datei detection_ext.py ist eine Erweiterung für das Programm Raha.
...
Als Standardkonfiguration wird zu 'Prop7' mit 'Het4' geraten für Datensätze mit vielen heterogenen Gruppen.
...
Falls der Datensatz sehr klein ist, kann der Anzahl an Nachbarn mit NEIGHBORS angepasst werden (Standard ist 5).
...
Zum testen wird die Datei eva.py verwendet. Die Datei detection_ext.py muss allerdings zu testen der Modi hinzugefügt werden.
